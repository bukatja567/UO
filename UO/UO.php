...
function labccna($chat_id, $mess){
		...
		switch ($i) {
			...
			case '2225' or '2225@uo_isit_bot': sendFile($chat_id, TBLAB2225); break;
			case '3012' or '@uo_isit_bot': sendFile($chat_id, TBLAB3012); break;
			case '31212' or '@uo_isit_bot': sendFile($chat_id, TBLAB31212); break;
			case '3323' or '@uo_isit_bot': sendFile($chat_id, TBLAB3323); break;
			case '3411' or '@uo_isit_bot': sendFile($chat_id, TBLAB3411); break;
			case '4012' or '@uo_isit_bot': sendFile($chat_id, TBLAB4012); break;
			case '4214' or '@uo_isit_bot': sendFile($chat_id, TBLAB4214); break;
			case '4224' or '@uo_isit_bot': sendFile($chat_id, TBLAB4224); break;
			case '4334' or '@uo_isit_bot': sendFile($chat_id, TBLAB4334); break;
			case '4411' or '@uo_isit_bot': sendFile($chat_id, TBLAB4411); break;
			case '5012' or '@uo_isit_bot': sendFile($chat_id, TBLAB5012); break;
			case '6012' or '@uo_isit_bot': sendFile($chat_id, TBLAB6012); break;
			case '6225' or '@uo_isit_bot': sendFile($chat_id, TBLAB6225); break;
			case '6435' or '@uo_isit_bot': sendFile($chat_id, TBLAB6435); break;
			case '6511' or '@uo_isit_bot': sendFile($chat_id, TBLAB6511); break;
			case '7012' or '@uo_isit_bot': sendFile($chat_id, TBLAB7012); break;
			case '7136' or '@uo_isit_bot': sendFile($chat_id, TBLAB7136); break;
			case '7236' or '@uo_isit_bot': sendFile($chat_id, TBLAB7236); break;
			case '7237' or '@uo_isit_bot': sendFile($chat_id, TBLAB7237); break;
			case '7311' or '@uo_isit_bot': sendFile($chat_id, TBLAB7311); break;
			case '8012' or '@uo_isit_bot': sendFile($chat_id, TBLAB8012); break;
			case '8245' or '@uo_isit_bot': sendFile($chat_id, TBLAB8245); break;
			case '8336' or '@uo_isit_bot': sendFile($chat_id, TBLAB8336); break;
			case '8411' or '@uo_isit_bot': sendFile($chat_id, TBLAB8411); break;
			case '9012' or '@uo_isit_bot': sendFile($chat_id, TBLAB9012); break;
			case '9228' or '@uo_isit_bot': sendFile($chat_id, TBLAB9228); break;
			case '9229' or '@uo_isit_bot': sendFile($chat_id, TBLAB9229); break;
			case '9311' or '@uo_isit_bot': sendFile($chat_id, TBLAB9311); break;
			case '10012' or '@uo_isit_bot': sendFile($chat_id, TBLAB10012); break;
			case '101113' or '@uo_isit_bot': sendFile($chat_id, TBLAB101113); break;
			case '10135' or '@uo_isit_bot': sendFile($chat_id, TBLAB10135); break;
			case '10233' or '@uo_isit_bot': sendFile($chat_id, TBLAB10233); break;
			case '10234' or '@uo_isit_bot': sendFile($chat_id, TBLAB10234); break;
			case '10245' or '@uo_isit_bot': sendFile($chat_id, TBLAB10245); break;
			case '10311' or '@uo_isit_bot': sendFile($chat_id, TBLAB10311); break;
